...
class MaskRCNN():
    ...
    def compile(self, learning_rate, momentum):
        ...
        self.keras_model.compile(
            optimizer=optimizer,
            loss=[None] * len(self.keras_model.outputs) # Add accuracy metrics here
        )
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        # After training is complete, plot the history
        self.plot_training_history(history_callback)
